the useEffect hook to create a custom hook that allows you to paste an image from the clipboard onto a canvas element using the ctrl+v keyboard shortcut:
